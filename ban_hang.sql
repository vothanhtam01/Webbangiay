...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 29, 2021 lúc 10:00 AM
...
(1, 'phuocadmin', 'e39be10e2e9edcf2b3224dfa2047a02a', 1);
...
--
ALTER TABLE `tbl_sanpham`
  MODIFY `id_sanpham` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
COMMIT;
